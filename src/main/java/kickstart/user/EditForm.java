...
interface EditForm {
	...
	@Pattern(regexp = "[CDATA[^(?=.*\\d)(?=.*[a-z])(?=.*[A-Z]).{4,32}$]]", message = "Passwort zu leicht! 4-32 Zeichen mit Zahlen und Groß- und Kleinbuchstaben!")
	String getPassword();
	...
	@Min(value=0, message = "Id kann nicht negativ sein!")
	String getId();
}
