...
public class CarpoolManager {
	...
	public CarpoolManager(CarCatalog carCatalog, AccountancyManager accountancyManager, OrderManager<Order> orderManager, UserAccountManager userAccountManager, BusinessTime businessTime) {
	...
	public void checkForError() {
		Iterable<Truck> temp = carCatalog.findByFree(false);
		for (Truck entry : temp) {
			String tempU = this.getTruckUserAccountMap().get(entry).getUsername();
