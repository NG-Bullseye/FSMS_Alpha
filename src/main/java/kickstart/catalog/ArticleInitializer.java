...
public class ArticleInitializer implements DataInitializer {
	...
	public void initialize() {
		...
		catalog.save(b1);
		Part b2 = new Part("Bettgestell 140x190","ein Bettgestell für eine 140x190 große Matratze",40,75.0, c1,cat2);
		catalog.save(b2);
		...
		catalog.save(b5);
		Part b6 = new Part("Bettgestell 180x190","ein Bettgestell für eine 180x190 große Matratze",50,80.0, c2,cat2);
		catalog.save(b6);
		...
		catalog.save(r2);
		Part r3 = new Part("Wandhalterung Regal","Anbauteile, um das Regal an einer Wand zu befestigen",30,6, c1,cat5);
		catalog.save(r3);
		...
		l4.add(b8);
		l4.add(b9);
		Composite com4 = new Composite("Bettzeug","ein Set bestehend aus Bettdeckke, Kissen und jeweiligen Bezügen",l4);
		catalog.save(com4);
